...
player1_inv_homes, player2_inv_homes, player3_inv_homes = \
    build_invalid_homes_sets(player1_set, player2_set, player3_set, player1_obj,
                             player2_obj, player3_obj)


def minimax(board, depth, player, first_player, player1_set, player2_set, player3_set):
    ...
    for move in valid_moves:
        ...
        score, something = minimax(new_board, depth - 1, next_player, first_player, player1_set, player2_set, player3_set)
        scores.append(score)
        moves.append(move)
...
def calculate_score(player_turn, p1_avg_distance, p2_avg_distance, p3_avg_distance):
    ...
    if player_turn == 1:
        ...
        score = ((p3_avg_distance - pturn_avg_distance) +
