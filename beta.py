...
def main():
    ...
    board = build_board()
    player1_set, player2_set, player3_set = build_sets()#, player4_set, player5_set, player6_set = build_sets()
    player1_obj, player2_obj, player3_obj = build_obj_sets()#, player4_obj, player5_obj, player6_obj = build_obj_sets()
    player1_invalid_home, player2_invalid_home, player3_invalid_home = build_invalid_homes_sets(player1_set, player2_set, player3_set, player1_obj, player2_obj, player3_obj)
        ...
        for event in pg.event.get():
            ...
            if event.type == next_move and not game_over:
                ...
                player1_set, player2_set, player3_set = \
                    update_player_set(set_pieces, player_turn, player1_set, player2_set, player3_set)
