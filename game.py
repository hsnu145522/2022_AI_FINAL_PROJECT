...
def main():
    ...
    #player4_set, player5_set, player6_set = build_sets()
    player1_obj, player2_obj, player3_obj = build_obj_sets()
    #player4_obj, player5_obj, player6_obj = build_obj_sets()
    player1_invalid_home, player2_invalid_home, player3_invalid_home = build_invalid_homes_sets(player1_set, player2_set, player3_set,
                                                                                                player1_obj, player2_obj, player3_obj)
